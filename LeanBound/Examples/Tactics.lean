...
This file demonstrates using LeanBound's interval arithmetic to prove
...
namespace LeanBound.Examples.Tactics

open LeanBound.Core
open LeanBound.Numerics
open LeanBound.Tactic
...
end LeanBound.Examples.Tactics
